...
# --- Chat/agent-log routes REMOVED ---
# Chat, status queries, setState, and agent logs now go through
# wss://gw.viewspark.ai/ws-live via frontend sendCommand().
# No more subprocess.run(bb ...) from Flask.
