...
# --- Chat/agent-log: now handled by frontend WS (sendCommand via wss://gw.viewspark.ai/ws-live) ---
# Removed: /chat, /chat/agents, /agent-log (were subprocess bb ask / lark-cli)
